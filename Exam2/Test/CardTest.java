...
public class CardTest {
	...
	Card[] royalFlush1 = { cardAC, cardKC, cardQC };
	...
	public void testIsRoyalFlush() {
		assertFalse("isRoyalFlush: returns true incorrectly", Card.isRoyalFlush(emptyDeck));
		assertFalse("isRoyalFlush: returns true incorrectly", Card.isRoyalFlush(deck1));
		assertFalse("isRoyalFlush: returns true incorrectly", Card.isRoyalFlush(straightFlush1));
		assertTrue("isRoyalFlush: returns false incorrectly", Card.isRoyalFlush(royalFlush1));
	}
